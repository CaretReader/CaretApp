...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    static let isSideloaded = Bundle.main.bundleIdentifier != "com.uvov.Caret"
    ...
    func application(
        ...
        UserDefaults.standard.register(
            defaults: [
                ...
                "Reader.autoRemoveDownloadChapters": false,
        ...
        let pipeline = ImagePipeline {
            ...
            let dataCache = try? DataCache(name: "com.uvov.Caret.datacache") // disk cache
    ...
    func handleUrl(url: URL) {
        if url.scheme == "caret" || url.scheme == "aidoku"  { // caret://
