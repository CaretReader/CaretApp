...
class BrowseViewController: BaseTableViewController {
    ...
    override func configure() {
        ...
        emptyStackView.showsButton = false // 隐藏手册链接按钮
    ...
    @objc func openGuidePage() {
        let safariViewController = SFSafariViewController(
            url: URL(string: "https://caret.uvov.com/help/guides/getting-started/#installing-a-profile")!
        )
...
extension BrowseViewController {
    ...
    class SourceCellDataSource: UITableViewDiffableDataSource<Section, SourceInfo2> {
        ...
        // iOS14 上不知道为什么没有运行下面的 tableView(_:canMoveRowAt:) ，导致无法进行排序
        // 所以需要新增 tableView(_:canEditRowAt:) 来给系统做判断
