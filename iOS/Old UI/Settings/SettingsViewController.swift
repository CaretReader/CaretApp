...
//                        subtitle: NSLocalizedString("INCOGNITO_MODE_TEXT", comment: "")
                    ...
                    SettingItem(type: "page",
                                key: "General.tintColor",
...
//                        title: NSLocalizedString("USE_MANGA_TINT", comment: "")
            ...
            SettingItem(type: "group", title: NSLocalizedString("READER", comment: ""), items: [
                ...
                SettingItem(type: "switch",
                            key: "Reader.autoRemoveDownloadChapters",
                            title: NSLocalizedString("AUTO_REMOVE_DOWNLOAD_CHAPTERS", comment: ""))
            ]),
...
//                SettingItem(type: "button", key: "Advanced.clearChapterCache", title: NSLocalizedString("CLEAR_CHAPTER_CACHE", comment: "")),
                ...
                SettingItem(type: "button", key: "Advanced.migrateHistory", title: NSLocalizedString("MIGRATE_CHAPTER_HISTORY", comment: "")),
            ...
            SettingItem(type: "group", title: NSLocalizedString("ABOUT", comment: ""), items: [
                ...
                SettingItem(type: "link", title: NSLocalizedString("HELP_CENTER", comment: ""), url: "https://caret.uvov.com/help/", external: true),
                SettingItem(type: "link", title: NSLocalizedString("GITHUB_REPO", comment: ""), url: "https://github.com/CaretReader/CaretApp", external: true)/*,
                SettingItem(type: "link", title: NSLocalizedString("TELEGRAM_CHANNEL", comment: ""), url: "https://t.me/CaretReader", external: true)*/
            ])
        ])
...
extension SettingsViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let item = items[indexPath.section].items?[indexPath.row] {
            ...
            case "General.tintColor":
                navigationController?.pushViewController(SettingsTintColorViewController(), animated: true)
...
//                }
            ...
            case "Advanced.migrateHistory":
                confirmAction(
                    title: NSLocalizedString("MIGRATE_CHAPTER_HISTORY", comment: ""),
                    message: NSLocalizedString("MIGRATE_CHAPTER_HISTORY_TEXT", comment: "")
                ) {
                    Task {
